...
import { Heading, Text } from '@libre-dev/uikit'
...
const NoNftsToClaimCard = () => {
  ...
  return (
    <SecondaryCard>
      <CardContent imgSrc="https://raw.githubusercontent.com/blzd-dev/blzd-frontend/master/public/images/present-disabled.svg">
